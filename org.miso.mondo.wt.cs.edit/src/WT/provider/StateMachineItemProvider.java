...
/**
 * This is the item provider adapter for a {@link WT.StateMachine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateMachineItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WTPackage.Literals.STATE_MACHINE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WTPackage.Literals.STATE_MACHINE__STATES);
			childrenFeatures.add(WTPackage.Literals.STATE_MACHINE__TRANSITIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WTPackage.Literals.STATE_MACHINE__STATES,
				 WTFactory.eINSTANCE.createInitialState()));

		newChildDescriptors.add
			(createChildParameter
				(WTPackage.Literals.STATE_MACHINE__STATES,
				 WTFactory.eINSTANCE.createSimpleState()));

		newChildDescriptors.add
			(createChildParameter
				(WTPackage.Literals.STATE_MACHINE__TRANSITIONS,
				 WTFactory.eINSTANCE.createEdge()));
	}
