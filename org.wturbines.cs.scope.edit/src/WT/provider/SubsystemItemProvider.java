...
/**
 * This is the item provider adapter for a {@link WT.Subsystem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubsystemItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WTPackage.Literals.SUBSYSTEM__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WTPackage.Literals.SUBSYSTEM__SUBSYSTEMS);
			childrenFeatures.add(WTPackage.Literals.SUBSYSTEM__ENSEMBLES);
			childrenFeatures.add(WTPackage.Literals.SUBSYSTEM__BEH);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WTPackage.Literals.SUBSYSTEM__SUBSYSTEMS,
				 WTFactory.eINSTANCE.createSubsystem()));

		newChildDescriptors.add
			(createChildParameter
				(WTPackage.Literals.SUBSYSTEM__ENSEMBLES,
				 WTFactory.eINSTANCE.createArchitecture()));

		newChildDescriptors.add
			(createChildParameter
				(WTPackage.Literals.SUBSYSTEM__BEH,
				 WTFactory.eINSTANCE.createControlSubsystem()));
	}
