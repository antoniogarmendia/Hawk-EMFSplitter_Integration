...
package org.wturbines.cs.scope.modular.decorator;
...
public class ModularProjectDecorator implements ILightweightLabelDecorator {
	...
	static {  
	 	PACKAGE_Subsystem = AbstractUIPlugin.imageDescriptorFromPlugin("org.wturbines.cs.scope.modular", "icons/Subsystem.png");
	 	PACKAGE_ControlSubsystem = AbstractUIPlugin.imageDescriptorFromPlugin("org.wturbines.cs.scope.modular", "icons/ControlSubsystem.png");
	}  	
