...
public class StateMachineCreateFileWizard extends Wizard implements INewWizard {
	private StateMachineCreateFileWizardPage page;
	private ISelection selection;

	/**
	 * Constructor for StateMachineCreateFileWizard.
	 */
	public StateMachineCreateFileWizard() {
		super();
	...
	public void addPages() {
		page = new StateMachineCreateFileWizardPage(selection);
		addPage(page);
	}
	...
	private void doFinish(
		...
		StateMachine rootObject = WTFactoryImpl.eINSTANCE.createStateMachine();
		...
		((EList<EObject>)file_xmi.Get_Root().eGet(file_xmi.Get_Root().eClass().getEStructuralFeature("states"), true)).add(child_xmi.Get_Root());
		file_xmi.Save_XMI();
