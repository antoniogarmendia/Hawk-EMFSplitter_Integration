...
package org.wturbines.cs.scope.modular.wizard.file;
...
import java.io.*;
import org.wturbines.cs.scope.modular.XMI_File;
...
public class ArchitectureCreateFileWizard extends Wizard implements INewWizard {
	private ArchitectureCreateFileWizardPage page;
	private ISelection selection;

	/**
	 * Constructor for ArchitectureCreateFileWizard.
	 */
	public ArchitectureCreateFileWizard() {
		super();
	...
	public void addPages() {
		page = new ArchitectureCreateFileWizardPage(selection);
		addPage(page);
	}
	...
	private void doFinish(
		...
		Architecture rootObject = WTFactoryImpl.eINSTANCE.createArchitecture();
		...
		((EList<EObject>)file_xmi.Get_Root().eGet(file_xmi.Get_Root().eClass().getEStructuralFeature("ensembles"), true)).add(child_xmi.Get_Root());
		file_xmi.Save_XMI();
